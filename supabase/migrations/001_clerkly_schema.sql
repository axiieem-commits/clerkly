...
create table if not exists public.clinical_cases (
  ...
  hopi_character text,
  hopi_radiation text,
  hopi_associations text,
  hopi_timing text,
  hopi_aggravating_relief text,
  hopi_severity text,
  main_system text,
  system_problem text,
  systemic_review_selections text,
  ...
  family_history text,
  social_history text,
  past_blood_transfusion text,
  menstrual_history text,
  family_similar_problem text,
  familial_disease text,
  occupation text,
  marital_status text,
  smoking_history text,
  alcohol_history text,
  promiscuity_history text,
  recreational_drug_history text,
  travel_history text,
  social_other text,
  findings text,
